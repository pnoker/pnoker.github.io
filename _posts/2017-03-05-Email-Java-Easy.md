...
public class SendMail {
    ...
    public static String myEmailAccount = "13476766389@163.com";
    public static String myEmailPassword = "abcd4455563";
    ...
    /*收件人邮箱（替换为自己知道的有效邮箱）*/
    public static String receiveMailAccount = "peter-no@foxmail.com";
